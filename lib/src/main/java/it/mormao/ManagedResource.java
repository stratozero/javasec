...
public class ManagedResource<C extends AutoCloseable> {
	private final Supplier<C> resourceSupplier;

	private ManagedResource(final Supplier<C> resourceSupplier){
